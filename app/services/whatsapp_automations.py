...
WHATSAPP_TRIGGER_BOOKING_CONFIRMED = "booking_confirmed"
WHATSAPP_TRIGGER_BOOKING_REJECTED = "booking_rejected"
...
ALLOWED_WHATSAPP_TRIGGERS = {
    ...
    WHATSAPP_TRIGGER_BOOKING_CONFIRMED,
    WHATSAPP_TRIGGER_BOOKING_REJECTED,
}
