...
const HIGHLIGHTS = [
  ...
  {
    label: "Documenti",
    value: "eventuale verifica del documento di identita solo nei casi necessari",
  },
] as const;
...
const SECTIONS: PrivacySection[] = [
  {
    ...
    paragraphs: [
      ...
      `Per informazioni sul trattamento dei dati personali o per l'esercizio dei diritti previsti dal GDPR e possibile contattare il Titolare ai recapiti seguenti: email ${CONTACT_DETAILS.email}; telefono ${CONTACT_DETAILS.phone}.`,
    ],
  },
  {
    title: "2. Categorie di dati trattati",
    intro:
      "Nel contesto dell'iscrizione e della gestione del rapporto associativo ASSONAM puo trattare, a seconda del caso concreto, le seguenti categorie di dati:",
    bullets: [
      ...
      "dati associativi, quali data di iscrizione, stato della pratica, numero tessera, anno di validita, associazione o club di riferimento e informazioni connesse al rapporto associativo;",
      ...
      "eventuale documento di identita e dati in esso contenuti, esclusivamente ove richiesto per attivita di verifica, validazione o documentazione della pratica;",
  ...
  },
  {
    ...
    intro: "I dati personali sono trattati per finalita determinate, esplicite e legittime, tra cui:",
    bullets: [
      "gestione della richiesta di iscrizione socio online e delle relative verifiche preliminari;",
      "verifica dell'identita dell'interessato e della documentazione allegata, ove necessaria;",
  ...
  },
  {
    ...
    intro:
      "Le basi giuridiche non sono richiamate in modo generico, ma vengono collegate alle singole finalita di trattamento:",
    bullets: [
      ...
      "i log di sicurezza, i controlli tecnici, la prevenzione di abusi e la protezione del portale si fondano sul legittimo interesse del Titolare alla sicurezza dei sistemi, alla continuita operativa e alla difesa dei propri diritti;",
      "eventuali trattamenti facoltativi ulteriori potranno essere basati sul consenso solo se effettivamente richiesto con informativa e raccolta dedicate; il presente flusso di iscrizione non presenta, allo stato, finalita promozionali o newsletter opzionali.",
    ],
  },
  {
    ...
    paragraphs: [
      ...
      "Il mancato conferimento dei dati necessari puo comportare l'impossibilita di completare l'iscrizione, di verificare correttamente la pratica, di attivare l'accesso all'area riservata o di erogare i servizi associativi richiesti.",
      "L'eventuale documento di identita e richiesto solo nei casi in cui sia necessario ai fini di verifica, validazione o documentazione della pratica; negli altri casi il mancato caricamento del documento non impedisce automaticamente il proseguimento se tale verifica non e necessaria.",
    ],
  },
  {
    title: "6. Destinatari o categorie di destinatari",
    intro: "I dati possono essere comunicati, nei limiti strettamente pertinenti alle finalita sopra indicate, a:",
    bullets: [
      ...
      "associazione, circolo o club di riferimento del socio, ove pertinente rispetto al modello organizzativo ASSONAM e nella misura necessaria per gestire iscrizione, validita della tessera e rapporto associativo;",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Ove cio avvenga, il trasferimento sara gestito nel rispetto del GDPR, mediante decisioni di adeguatezza della Commissione europea, clausole contrattuali standard o altri strumenti di garanzia ritenuti idonei in relazione al servizio utilizzato.",
    ],
  },
  {
    title: "8. Periodo di conservazione",
    intro:
      "I dati sono conservati secondo criteri differenziati, proporzionati alla finalita perseguita e alla natura del rapporto con il socio:",
    bullets: [
      ...
      "i dati del rapporto associativo, del libro soci digitale, dell'account e della tessera associativa digitale sono trattati per la durata dell'anno associativo corrente e, al termine del relativo ciclo annuale, i dati non piu necessari vengono cancellati o resi non identificativi insieme alla tessera associativa, salvo ulteriore conservazione strettamente necessaria per adempimenti amministrativi, organizzativi, fiscali o per la tutela dei diritti del Titolare;",
      "i log tecnici e di autenticazione sono conservati per tempi proporzionati alle finalita di sicurezza, prevenzione abusi e continuita operativa;",
      "la copia del documento di identita, quando richiesta, e conservata solo per il tempo strettamente necessario alla finalita di verifica o documentazione per cui e stata acquisita, salvo eventuali ulteriori obblighi di conservazione o esigenze di tutela giuridica.",
    ],
    note:
  ...
  {
    title: "9. Modalita del trattamento e misure di sicurezza",
    paragraphs: [
      "Il trattamento avviene mediante strumenti informatici, telematici e organizzativi adeguati alla natura dei dati trattati e alle finalita perseguite, secondo principi di liceita, correttezza, trasparenza, minimizzazione e limitazione della conservazione.",
  ...
  },
  {
    ...
    intro:
      "Nei casi previsti dagli articoli 15 e seguenti del GDPR, l'interessato puo esercitare i seguenti diritti:",
    bullets: [
      ...
      "revocare in qualsiasi momento l'eventuale consenso prestato, senza pregiudicare la liceita del trattamento precedente alla revoca, nei soli casi in cui il trattamento si fondi effettivamente sul consenso;",
      "proporre reclamo al Garante per la protezione dei dati personali.",
    ],
    note:
      `Per esercitare i propri diritti e possibile scrivere a ${CONTACT_DETAILS.email}. Il Titolare potra richiedere informazioni aggiuntive strettamente necessarie a verificare l'identita del richiedente.`,
  },
  {
    title: "11. Cookie",
    paragraphs: [
      ...
      "Per eventuali strumenti ulteriori o per aggiornamenti della configurazione tecnica potra essere resa disponibile una informativa o cookie policy dedicata, ove necessaria.",
    ],
  },
] as const;
