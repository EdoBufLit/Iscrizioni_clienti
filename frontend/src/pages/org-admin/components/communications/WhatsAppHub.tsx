...
const lightStatusCopy: Record<OrgAdminWhatsAppConnection["status"], string> = {
  not_connected: "border-slate-200 bg-slate-100 text-slate-700",
  qr_required: "border-amber-200 bg-amber-50 text-amber-700",
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span className="text-xs text-slate-500">
              Numero collegato: <span className="font-semibold text-slate-900">{connection.phone_number ?? "non disponibile"}</span>
            </span>
            <span className="text-xs text-slate-500">
              Ultimo sync: <span className="font-semibold text-slate-900">{formatPanelDate(connection.updated_at)}</span>
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-start justify-between gap-5">
            <div className="max-w-xl">
              ...
              <p className="mt-2 text-sm text-slate-600">
                ...
                {" "}
                <span className="font-semibold text-slate-900">Connetti</span>.
              </p>
            </div>
              ...
              <div className="border-b border-[#203239] px-5 py-4">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-[#8696a0]">Conversazioni sincronizzate, stato connessione e azioni rapide.</p>
                  </div>
                  <button
                    type="button"
              ...
              <div className="min-h-0 flex-1 overflow-y-auto">
                {sidebarItems.length === 0 ? (
                  <div className="px-5 py-8 text-sm text-[#8696a0]">
                    {connection.status === "connected"
                      ? "Nessuna conversazione disponibile ancora. Prova ad aprire una nuova chat."
                      : "Connetti WhatsApp per vedere le conversazioni."}
                  </div>
                ) : (
                  <div className="py-2">
