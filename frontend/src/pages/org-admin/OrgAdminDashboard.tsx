      ...
      {isLoading ? (
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="surface p-7">
            ...
            <p className="mt-3 text-2xl font-semibold tabular-nums text-neutral-900">
              {metrics?.card_min ? `${metrics.card_min}–${metrics.card_max}` : "—"}
            </p>
            <p className="mt-2 text-sm leading-6 text-neutral-600">
              Intervallo numeri tessere.
            </p>
          </div>
          ...
          {(() => {
            const exhausted =
              metrics?.cards_remaining === 0 && metrics?.cards_total != null;
            return (
              <div
              ...
              >
                ...
                >
                  <svg
                    ...
                    strokeLinejoin="round"
                  >
                    <path d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Zm6-10.125a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm-1.875 6.375a3 3 0 0 0-3 3h6a3 3 0 0 0-3-3Z" />
                  </svg>
                </div>
                <p className="mt-4 text-xs font-medium uppercase tracking-[0.2em] text-neutral-400">
                  Tessere rimanenti
                ...
                >
                  {metrics?.cards_remaining !== null ? metrics?.cards_remaining : "N/D"}
                </p>
                <p className="mt-2 text-sm leading-6 text-neutral-600">
                  Disponibili per nuove assegnazioni.
                </p>
          ...
          <div className="surface p-7">
            ...
            <p className="mt-3 text-2xl font-semibold tabular-nums text-neutral-900">
              {metrics?.pending_requests_count !== null ? metrics?.pending_requests_count : "N/D"}
            </p>
            <p className="mt-2 text-sm leading-6 text-neutral-600">
