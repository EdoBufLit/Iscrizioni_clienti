      ...
      case "booking_block":
        return (
          <div className="form-builder-booking-link__field grid w-full gap-3 rounded-[0.75rem] border px-3 py-3">
            <div>
              <span className="text-sm font-semibold text-slate-900">Prenotazione</span>
              <p className="mt-1 text-xs leading-5 text-slate-500">Giorno e orario liberi, serata proposta se presente.</p>
            </div>
